...
public class StringIntro {
    ...
    public static void main(String[] args) {
        ...
        String str2 = new String(" Wooden Spoon"); // all those object created in the heap outside the string pool
        ...
        System.out.println(s3.equals(s4)); // Because it s4 is starts with lower case
